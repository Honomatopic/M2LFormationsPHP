...
<fieldset>
	...
	<?php while($laSalle = pg_fetch_assoc($requete_exec)):?>
		<input type="hidden" name="id" value=<?php echo $_GET["id"]; ?>> <input
			type="text" name="nom" value="<?php echo $laSalle["nom"]; ?>"> <br> <input
			type="submit" name="modifiersalle" value="&#128397;&#65039; Modifier">
		&nbsp; <input type="submit" name="supprimersalle"
			onclick="return confirm('Etes-vous sûr de supprimer cette salle ?');"
			value="&#128465;&#65039; Supprimer">
	</form>
</fieldset>
<?php
