...
if (isset($_GET["id"])) {
    $id = $_GET["id"];
    $lutilisateur = selectionnerUnUtilisateurParlId($id);
    $nom = $lutilisateur["nomUtilisateur"];
    $prenom = $lutilisateur["prenomUtilisateur"];
    $email = $lutilisateur["emailUtilisateur"];
    $motpasse = $lutilisateur["motpasseUtilisateur"];
    $statut = $lutilisateur["statutUtilisateur"];
}
?>
<section>
