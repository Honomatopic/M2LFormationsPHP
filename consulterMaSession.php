...
echo "<td></td>";
;?>
<a href="seDesinscrireDeMaSession.traitement.php?eemploye_id=<?php echo $_SESSION["id"] ;?>&ssession_id=<?php echo $laSession["id_session"];?>"><button>&#128395;&#65039; Me désinscrire de cette formation</button></a>
