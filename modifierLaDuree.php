...
<fieldset>
	...
	<?php while ($laduree = pg_fetch_assoc($requete_exec)) : ?>
		<input type="hidden" name="id" value=<?php echo $_GET["id"]; ?>> <input
			...
			value="<?php echo $laduree["datedebut"]; ?>"> <br>
		<input type="date" name="datefin"
			value="<?php echo $laduree["datefin"]; ?>"> <br> <input type="submit"
			name="modifierduree" value="&#128397;&#65039; Modifier"> &nbsp; <input
			type="submit" name="supprimerduree"
			onclick="return confirm('Etes-vous sûr de supprimer cette durée ?');"
			value="&#128465;&#65039; Supprimer">
	</form>
</fieldset>
<?php endwhile ;pg_close($cnx) ; };?>
