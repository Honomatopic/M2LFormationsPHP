...
echo "<td></td>";
;?>
<a href="consulterLaSession.php?employe_id=<?php echo $_SESSION["id"] ;?>&session_id=<?php echo $laSession["id"];?>"><button>&#128395;&#65039; M'inscrire de cette session de formation</button></a>
